<?php 
	...
	if(isset($_POST['watermarkPosition'])  && !empty($_FILES)){
			...
			$watermarkSizeX = intval($_POST['size']*($watermarkWidth/100));
			$watermarkSizeY = intval($_POST['size']*($watermarkHeight/100));
			$margin = $_POST['margin'];
 ...
 <body>
 	<form action="watermark.php" method="POST" enctype="multipart/form-data">
 		...
 		Margin: <input type="number" name="margin" min="0" max="1000" step="1" value="10"><br>
